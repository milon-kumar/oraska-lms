...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <form action="<?php echo e(route('admin.opinion.store')); ?>" method="post" enctype="multipart/form-data" class="card border shadow">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Milon Kumar Tailwind Css\Laravel\Oraska LMS\lms\resources\views/backend/admin/pages/opinion/create.blade.php ENDPATH**/ ?>