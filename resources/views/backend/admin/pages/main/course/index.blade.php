            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        @include('backend.admin.components.main.course_table_tabs')
                    </div>
                    <div class="card-body">
                                ...
                                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    @foreach($courses as $course)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.main.show',$course->slug ?? '') }}" class="btn btn-success btn-sm"><i class="dripicons-expand"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
